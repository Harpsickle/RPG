...
class Battle {
    ...
    if (CharacterStats.charHealth > 0 && EnemyStats.enemyHealth == 0) {
    ...
    else if ((EnemyStats.enemyHealth > 0 && CharacterStats.charHealth == 0) || (EnemyStats.enemyHealth == 0 && CharacterStats.charHealth == 0)) {
